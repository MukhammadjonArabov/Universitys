...
class University(BaseModel):
    ...
    # Counts for display (can be filled from admin or sync scripts)
    faculties_count = models.PositiveIntegerField(default=0)
    directions_count = models.PositiveIntegerField(default=0)
    students_count = models.PositiveIntegerField(default=0)
    # Number of professional/teaching staff (professors/lecturers)
    professors_count = models.PositiveIntegerField(default=0)
